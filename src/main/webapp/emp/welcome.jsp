	...
	<section>
		<div class="container">
			...
			<div class="row-fluid">
				...
				<ul class="nav nav-pills pull-right">
					<li class="active"><s:a href="changepw.jsp">Change Password</s:a>
					</li>
 ...
 Your Last Login was at : <b><s:property value="user2" /> </b>
				...
				<div class="container">
					...
					<div class="span10">
						<div class="well">
							<strong>
								<p class="text-center">General Information About Employee
									Actions</p>
							</strong>
							...
							<dl class="dl-horizontal">
								...
								<dd>Employee can check Loan Eligibility based on certain
									factors</dd>
								<dd>Employee will need Client Account Id</dd>
								<p>&nbsp;</p>-->
								<dt>Add Clients</dt>
								...
								<dd>
									<b>Employee will need all details of Clients</b>
								</dd>
								<dd>
									<b>Employee will need New Client Account Id</b>
								</dd>
				...
				<div class="container">
					...
					<div class="row">
						<div class="span2">
							<a href="addtrans.jsp" class="btn btn-primary"> <i
								class="icon-pencil icon-white"></i> <span><strong>Deposit
										Amount</strong></span>
							</a>
						</div>
						<div class="span2">
							<a href="addwith.jsp" class="btn btn-primary"> <i
								class="icon-tasks icon-white"></i> <span><strong>Withdrawn
										Amount</strong></span>
							</a>
						</div>
						<div class="span2">
							<a href="empview.jsp" class="btn btn-primary"> <i
								class="icon-eye-open icon-white"></i> <span><strong>View
										Transactions</strong></span>
							</a>
						</div>
						<!-- 
						<form class="span2" action="loancheck" method="post">
					...
					<div class="row">
						<div class="span2">
							<a href="addclient.jsp" class="btn btn-primary"> <i
								class="icon-edit icon-white"></i> <span><strong>Add
										New Clients</strong></span>
							</a>
						</div>
						<div class="span2">
							<a href="edit_client.jsp" class="btn btn-primary"> <i
								class="icon-user icon-white"></i> <span><strong>Edit
										Client Details</strong></span>
							</a>
						</div>
					</div>
				</div>
