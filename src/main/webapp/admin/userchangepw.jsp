		...
		<div class="container">
			...
			<div class="row-fluid">
				...
				<div class="container" style="margin-top: 50px;">
					...
					<div class="span10">
						...
						<div class="alert alert-info">
							<b>After changing the password successfully your account will
								be logout </b>
						</div>
				...
				<div class="container" style="margin-top: 100px;">
					...
					<div class="span8">
						<form class="form-horizontal" action="adm_user_changepw"
							method="post">
							<fieldset>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="textinput" name="chpw.bank_id" type="text"
											placeholder="Enter Bank Client Id" class="input-xlarge">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="textinput" name="chpw.newpw" type="password"
											placeholder="Enter New Password" class="input-xlarge">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="textinput" name="chpw.cnewpw" type="password"
											placeholder="Enter Again New Password" class="input-xlarge">
